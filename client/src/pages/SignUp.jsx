              ...
              <div className="relative">
                ...
                <svg
                  ...
                  className={`bi bi-eye absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer z-20 ${
                    isPasswordVisible ? "opacity-100" : "hidden"
                  }`}
                  viewBox="0 0 16 16"
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className={`i bi-eye-slash-fill absolute top-1/2 right-3 -z-1 -translate-y-1/2 cursor-pointer ${
                    isPasswordVisible ? "hidden" : "opacity-100"
                  }`}
                  id="mama"
                  viewBox="0 0 16 16"
                  onClick={togglePasswordVisibilty}
